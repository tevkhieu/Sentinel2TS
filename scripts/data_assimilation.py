...
def create_arg_parser():
    ...
    parser.add_argument(
        "--max_epochs", type=int, default=200, help="Max number of epochs"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to the data where assimilation will be done",
    )
    parser.add_argument(
        "--min_x",
        type=int,
        default=0,
        help="Minimal value of x where data will be assimilated",
    )
    parser.add_argument(
        "--max_x",
        type=int,
        default=100,
        help="Maximal value of x where data will be assimilated",
    )
    parser.add_argument(
        "--min_y",
        type=int,
        default=0,
        help="Minimal value of y where data will be assimilated",
    )
    parser.add_argument(
        "--max_y",
        type=int,
        default=100,
        help="Maximal value of y where data will be assimilated",
    )
    parser.add_argument(
        "--lr", type=float, default=1e-4, help="Learning rate for data assimilation"
    )
    parser.add_argument(
...
def main():
    ...
    if args.mode == "linear":
        model = Linear(20).to(args.device)
